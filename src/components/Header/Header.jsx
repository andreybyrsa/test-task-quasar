    ...
    <div className={HeaderClassName}>
      ...
      <div className="header__tracker">
        <div className="header__tracker-task">
          <Typography variant={TypographyVariantsTypes.Text_regular} color={colors.gray_100}>Сделать UI-kit</Typography>
          <Icon iconPath={IconsPaths.stop} color={colors.primary} />
        </div>
        <div className="header__tracker-timer">
          <Typography>Сегодня:</Typography>
          <Typography variant={TypographyVariantsTypes.Time_regular}>0:20:42</Typography>
        </div>
      </div>
    </div>
  );
